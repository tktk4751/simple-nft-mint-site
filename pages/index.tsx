...
const Home: NextPage = () => {
  ...
  const editionDrop = useEditionDrop(
    "0x2e963efAD826d31B21C9759f5ECAaD3583525C22"
  );
  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        {!address ? (
          <Image
            src="./cover-18695426076671673.png"
            rounded="full"
            width="42%"
            mt="5"
            maxW="300px"
        ...
        {address ? (
          <>
            ...
            <Button
              ...
              onClick={() =>
                window.open(
                  "<https://testnets.opensea.io/assets/goerli/0x2e963efAD826d31B21C9759f5ECAaD3583525C22/0>",
                  "_blank"
                )
              }
            >
